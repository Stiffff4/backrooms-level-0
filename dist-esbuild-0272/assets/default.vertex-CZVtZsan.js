import{t as ShaderStore}from"./shaderStore-DrmLqj-8.js";import{a as bonesVertexWGSL,c as fogVertexDeclarationWGSL,d as bonesDeclarationWGSL,i as bakedVertexAnimationWGSL,l as clipPlaneVertexDeclarationWGSL,n as fogVertexWGSL,o as instancesVertexWGSL,r as clipPlaneVertexWGSL,s as instancesDeclarationWGSL,t as vertexColorMixingWGSL,u as bakedVertexAnimationDeclarationWGSL}from"./vertexColorMixing-rSeANV_R.js";import{a as sceneUboDeclarationWGSL,i as meshUboDeclarationWGSL,n as mainUVVaryingDeclarationWGSL,r as defaultUboDeclarationWGSL,t as logDepthDeclarationWGSL}from"./logDepthDeclaration-BjZT99XJ.js";import{t as helperFunctionsWGSL}from"./helperFunctions-mkctowEF.js";var name$18="uvAttributeDeclaration",shader$18=`#if defined(UV{X}) && !defined(USE_VERTEX_PULLING)
attribute uv{X}: vec2f;
#endif
`;ShaderStore.IncludesShadersStoreWGSL[name$18]||(ShaderStore.IncludesShadersStoreWGSL[name$18]=shader$18);var uvAttributeDeclarationWGSL={name:name$18,shader:shader$18},name$17="prePassVertexDeclaration",shader$17=`#ifdef PREPASS
...
#endif
#endif
`;ShaderStore.IncludesShadersStoreWGSL[name$17]||(ShaderStore.IncludesShadersStoreWGSL[name$17]=shader$17);var prePassVertexDeclarationWGSL={name:name$17,shader:shader$17},name$16="samplerVertexDeclaration",shader$16=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
varying v_VARYINGNAME_UV: vec2f;
#endif
`;ShaderStore.IncludesShadersStoreWGSL[name$16]||(ShaderStore.IncludesShadersStoreWGSL[name$16]=shader$16);var samplerVertexDeclarationWGSL={name:name$16,shader:shader$16},name$15="bumpVertexDeclaration",shader$15=`#if defined(BUMP) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
#if defined(TANGENT) && defined(NORMAL) 
varying vTBN0: vec3f;varying vTBN1: vec3f;varying vTBN2: vec3f;
#endif
#endif
`;ShaderStore.IncludesShadersStoreWGSL[name$15]||(ShaderStore.IncludesShadersStoreWGSL[name$15]=shader$15);var bumpVertexDeclarationWGSL={name:name$15,shader:shader$15},name$14="lightVxFragmentDeclaration",shader$14=`#ifdef LIGHT{X}
...
#endif
#endif
`;ShaderStore.IncludesShadersStoreWGSL[name$14]||(ShaderStore.IncludesShadersStoreWGSL[name$14]=shader$14);var lightVxFragmentDeclarationWGSL={name:name$14,shader:shader$14},name$13="lightVxUboDeclaration",shader$13=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
#endif
`;ShaderStore.IncludesShadersStoreWGSL[name$13]||(ShaderStore.IncludesShadersStoreWGSL[name$13]=shader$13);var lightVxUboDeclarationWGSL={name:name$13,shader:shader$13},name$12="morphTargetsVertexGlobalDeclaration",shader$12=`#ifdef MORPHTARGETS
...
#endif
#endif
`;ShaderStore.IncludesShadersStoreWGSL[name$12]||(ShaderStore.IncludesShadersStoreWGSL[name$12]=shader$12);var morphTargetsVertexGlobalDeclarationWGSL={name:name$12,shader:shader$12},name$11="morphTargetsVertexDeclaration",shader$11=`#ifdef MORPHTARGETS
...
#endif
#endif
`;ShaderStore.IncludesShadersStoreWGSL[name$11]||(ShaderStore.IncludesShadersStoreWGSL[name$11]=shader$11);var morphTargetsVertexDeclarationWGSL={name:name$11,shader:shader$11},name$10="vertexPullingDeclaration",shader$10=`#ifdef USE_VERTEX_PULLING
...
#endif
#endif
`;ShaderStore.IncludesShadersStoreWGSL[name$10]||(ShaderStore.IncludesShadersStoreWGSL[name$10]=shader$10);var vertexPullingDeclarationWGSL={name:name$10,shader:shader$10},name$9="vertexPullingVertex",shader$9=`#ifdef USE_VERTEX_PULLING
...
#endif
#endif
`;ShaderStore.IncludesShadersStoreWGSL[name$9]||(ShaderStore.IncludesShadersStoreWGSL[name$9]=shader$9);var vertexPullingVertexWGSL={name:name$9,shader:shader$9},name$8="morphTargetsVertexGlobal",shader$8=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
var vertexID : f32;
#endif
#endif
`;ShaderStore.IncludesShadersStoreWGSL[name$8]||(ShaderStore.IncludesShadersStoreWGSL[name$8]=shader$8);var morphTargetsVertexGlobalWGSL={name:name$8,shader:shader$8},name$7="morphTargetsVertex",shader$7=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
#if {X}==0
...
#endif
#endif
`;ShaderStore.IncludesShadersStoreWGSL[name$7]||(ShaderStore.IncludesShadersStoreWGSL[name$7]=shader$7);var morphTargetsVertexWGSL={name:name$7,shader:shader$7},name$6="prePassVertex",shader$6=`#ifdef PREPASS_DEPTH
...
#endif
#endif
`;ShaderStore.IncludesShadersStoreWGSL[name$6]||(ShaderStore.IncludesShadersStoreWGSL[name$6]=shader$6);var prePassVertexWGSL={name:name$6,shader:shader$6},name$5="uvVariableDeclaration",shader$5=`#ifdef MAINUV{X}
#if !defined(UV{X})
...
#endif
`;ShaderStore.IncludesShadersStoreWGSL[name$5]||(ShaderStore.IncludesShadersStoreWGSL[name$5]=shader$5);var uvVariableDeclarationWGSL={name:name$5,shader:shader$5},name$4="samplerVertexImplementation",shader$4=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
...
#endif
#endif
`;ShaderStore.IncludesShadersStoreWGSL[name$4]||(ShaderStore.IncludesShadersStoreWGSL[name$4]=shader$4);var samplerVertexImplementationWGSL={name:name$4,shader:shader$4},name$3="bumpVertex",shader$3=`#if defined(BUMP) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
#if defined(TANGENT) && defined(NORMAL)
var tbnNormal: vec3f=normalize(normalUpdated);var tbnTangent: vec3f=normalize(tangentUpdated.xyz);var tbnBitangent: vec3f=cross(tbnNormal,tbnTangent)*tangentUpdated.w;var matTemp= mat3x3f(finalWorld[0].xyz,finalWorld[1].xyz,finalWorld[2].xyz)* mat3x3f(tbnTangent,tbnBitangent,tbnNormal);vertexOutputs.vTBN0=matTemp[0];vertexOutputs.vTBN1=matTemp[1];vertexOutputs.vTBN2=matTemp[2];
#endif
#endif
`;ShaderStore.IncludesShadersStoreWGSL[name$3]||(ShaderStore.IncludesShadersStoreWGSL[name$3]=shader$3);var bumpVertexWGSL={name:name$3,shader:shader$3},name$2="shadowsVertex",shader$2=`#ifdef SHADOWS
...
#endif
#endif
`;ShaderStore.IncludesShadersStoreWGSL[name$2]||(ShaderStore.IncludesShadersStoreWGSL[name$2]=shader$2);var shadowsVertexWGSL={name:name$2,shader:shader$2},name$1="logDepthVertex",shader$1=`#ifdef LOGARITHMICDEPTH
vertexOutputs.vFragmentDepth=1.0+vertexOutputs.position.w;vertexOutputs.position.z=log2(max(0.000001,vertexOutputs.vFragmentDepth))*uniforms.logarithmicDepthConstant;
#endif
`;ShaderStore.IncludesShadersStoreWGSL[name$1]||(ShaderStore.IncludesShadersStoreWGSL[name$1]=shader$1);var logDepthVertexWGSL={name:name$1,shader:shader$1},name="defaultVertexShader",shader=`#include<defaultUboDeclaration>
