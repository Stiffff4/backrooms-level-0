const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/rgbdDecode.fragment-kFvTJcJi.js","assets/shaderStore-CeBEoMrR.js","assets/helperFunctions-CIjb1uV7.js","assets/rgbdDecode.fragment-Cnl3RDh4.js","assets/helperFunctions-8PhqkYrA.js"])))=>i.map(i=>d[i]);
import { i as GetBlobBufferSource } from "./guid-DgALBCu_.js";
import { t as Logger } from "./logger-BcrUU1RW.js";
import { s as IsExponentOfTwo, t as PostProcess } from "./postProcess.pure-DyzOl4n1.js";
import { t as BaseTexture } from "./baseTexture.pure-DPKCrMk9.js";
import { u as Vector3 } from "./math.color.pure-Cmv0AWRo.js";
import { r as ILog2 } from "./math.scalar.functions-DxmoiihM.js";
import { t as __vitePreload } from "./preload-helper-NSp6fEao.js";
import { t as InternalTexture } from "./internalTexture-BIxzv19R.js";
import { n as SphericalPolynomial } from "./sphericalPolynomial.pure-CpfBjTEf.js";
import { t as CubeMapToSphericalPolynomialTools } from "./cubemapToSphericalPolynomial-DifTnaAa.js";
...
async function _UploadLevelsAsync(texture, imageData, canGenerateNonLODTextures, imageType = DefaultEnvironmentTextureImageType) {
	...
	if (expandTexture) {
		if (engine.isWebGPU) {
			shaderLanguage = 1;
			await __vitePreload(() => import("./rgbdDecode.fragment-kFvTJcJi.js"), __vite__mapDeps([0,1,2]));
		} else await __vitePreload(() => import("./rgbdDecode.fragment-Cnl3RDh4.js"), __vite__mapDeps([3,1,4]));
