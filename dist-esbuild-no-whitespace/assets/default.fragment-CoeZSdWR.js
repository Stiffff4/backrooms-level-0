...
var name$21 = "prePassDeclaration", shader$21 = `#ifdef PREPASS
...
#endif
`;
ShaderStore.IncludesShadersStoreWGSL[name$21] || (ShaderStore.IncludesShadersStoreWGSL[name$21] = shader$21);
var prePassDeclarationWGSL = {
  name: name$21,
  shader: shader$21
}, name$20 = "oitDeclaration", shader$20 = `#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;
ShaderStore.IncludesShadersStoreWGSL[name$20] || (ShaderStore.IncludesShadersStoreWGSL[name$20] = shader$20);
...
#endif
`;
ShaderStore.IncludesShadersStoreWGSL[name$19] || (ShaderStore.IncludesShadersStoreWGSL[name$19] = shader$19);
var lightUboDeclarationWGSL = {
  name: name$19,
  shader: shader$19
}, name$18 = "ltcHelperFunctions", shader$18 = `fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
var ltcHelperFunctionsWGSL = {
  name: name$18,
  shader: shader$18
}, name$17 = "clusteredLightingFunctions", shader$17 = `struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
vLightDirection: vec4f,
vLightFalloff: vec4f,}
...
var fresnelFunctionWGSL = {
  name: name$13,
  shader: shader$13
}, name$12 = "reflectionFunction", shader$12 = `fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
var imageProcessingDeclarationWGSL = {
  name: name$11,
  shader: shader$11
}, name$10 = "imageProcessingFunctions", shader$10 = `#if TONEMAPPING==3
...
var bumpFragmentFunctionsWGSL = {
  name: name$7,
  shader: shader$7
}, name$6 = "bumpFragment", shader$6 = `var uvOffset: vec2f= vec2f(0.0,0.0);
...
var oitFragmentWGSL = {
  name: name$1,
  shader: shader$1
}, name = "defaultPixelShader", shader = `#include<defaultUboDeclaration>
