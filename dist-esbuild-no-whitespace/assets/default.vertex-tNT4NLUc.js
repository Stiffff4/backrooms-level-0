...
var name$19 = "decalVertexDeclaration", shader$19 = `#ifdef DECAL
...
var decalVertexDeclaration = {
  name: name$19,
  shader: shader$19
}, name$18 = "defaultVertexDeclaration", shader$18 = `uniform mat4 viewProjection;
#ifdef MULTIVIEW
...
var defaultVertexDeclaration = {
  name: name$18,
  shader: shader$18
}, name$17 = "uvAttributeDeclaration", shader$17 = `#ifdef UV{X}
attribute vec2 uv{X};
#endif
`;
...
var uvAttributeDeclaration = {
  name: name$17,
  shader: shader$17
}, name$16 = "prePassVertexDeclaration", shader$16 = `#ifdef PREPASS
...
var prePassVertexDeclaration = {
  name: name$16,
  shader: shader$16
}, name$15 = "samplerVertexDeclaration", shader$15 = `#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
...
var samplerVertexDeclaration = {
  name: name$15,
  shader: shader$15
}, name$14 = "bumpVertexDeclaration", shader$14 = `#if defined(BUMP) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
...
var bumpVertexDeclaration = {
  name: name$14,
  shader: shader$14
}, name$13 = "lightVxFragmentDeclaration", shader$13 = `#ifdef LIGHT{X}
...
var lightVxFragmentDeclaration = {
  name: name$13,
  shader: shader$13
}, name$12 = "lightVxUboDeclaration", shader$12 = `#ifdef LIGHT{X}
uniform Light{X}
...
var lightVxUboDeclaration = {
  name: name$12,
  shader: shader$12
}, name$11 = "morphTargetsVertexGlobalDeclaration", shader$11 = `#ifdef MORPHTARGETS
...
var morphTargetsVertexGlobalDeclaration = {
  name: name$11,
  shader: shader$11
}, name$10 = "morphTargetsVertexDeclaration", shader$10 = `#ifdef MORPHTARGETS
...
var morphTargetsVertexDeclaration = {
  name: name$10,
  shader: shader$10
}, name$9 = "morphTargetsVertexGlobal", shader$9 = `#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
float vertexID;
#endif
#endif
...
var morphTargetsVertexGlobal = {
  name: name$9,
  shader: shader$9
}, name$8 = "morphTargetsVertex", shader$8 = `#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
#if {X}==0
...
var morphTargetsVertex = {
  name: name$8,
  shader: shader$8
}, name$7 = "prePassVertex", shader$7 = `#ifdef PREPASS_DEPTH
...
var prePassVertex = {
  name: name$7,
  shader: shader$7
}, name$6 = "uvVariableDeclaration", shader$6 = `#if !defined(UV{X}) && defined(MAINUV{X})
vec2 uv{X}=vec2(0.,0.);
#endif
#ifdef MAINUV{X}
vMainUV{X}=uv{X};
...
var uvVariableDeclaration = {
  name: name$6,
  shader: shader$6
}, name$5 = "samplerVertexImplementation", shader$5 = `#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
if (v_INFONAME_==0.)
...
var samplerVertexImplementation = {
  name: name$5,
  shader: shader$5
}, name$4 = "bumpVertex", shader$4 = `#if defined(BUMP) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
#if defined(TANGENT) && defined(NORMAL)
...
var bumpVertex = {
  name: name$4,
  shader: shader$4
}, name$3 = "shadowsVertex", shader$3 = `#ifdef SHADOWS
...
var logDepthVertex = {
  name: name$1,
  shader: shader$1
}, name = "defaultVertexShader", shader = `#define CUSTOM_VERTEX_EXTENSION
