...
import { a as sceneUboDeclaration, i as meshUboDeclaration, n as mainUVVaryingDeclaration, r as defaultUboDeclaration, t as logDepthDeclaration } from "./logDepthDeclaration-Binpu8L7.js";
import { t as helperFunctions } from "./helperFunctions-CuolA418.js";
var name$24 = "decalFragmentDeclaration", shader$24 = `#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;
ShaderStore.IncludesShadersStore[name$24] || (ShaderStore.IncludesShadersStore[name$24] = shader$24);
var decalFragmentDeclaration = {
  name: name$24,
  shader: shader$24
}, name$23 = "defaultFragmentDeclaration", shader$23 = `uniform vec4 vEyePosition;uniform vec4 vDiffuseColor;uniform vec4 vSpecularColor;uniform vec3 vEmissiveColor;uniform vec3 vAmbientColor;uniform float visibility;
#ifdef DIFFUSE
...
`;
ShaderStore.IncludesShadersStore[name$23] || (ShaderStore.IncludesShadersStore[name$23] = shader$23);
var defaultFragmentDeclaration = {
  name: name$23,
  shader: shader$23
}, name$22 = "prePassDeclaration", shader$22 = `#ifdef PREPASS
...
#endif
`;
ShaderStore.IncludesShadersStore[name$22] || (ShaderStore.IncludesShadersStore[name$22] = shader$22);
var prePassDeclaration = {
  name: name$22,
  shader: shader$22
}, name$21 = "oitDeclaration", shader$21 = `#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;
ShaderStore.IncludesShadersStore[name$21] || (ShaderStore.IncludesShadersStore[name$21] = shader$21);
var oitDeclaration = {
  name: name$21,
  shader: shader$21
}, name$20 = "lightFragmentDeclaration", shader$20 = `#ifdef LIGHT{X}
...
#endif
`;
ShaderStore.IncludesShadersStore[name$20] || (ShaderStore.IncludesShadersStore[name$20] = shader$20);
var lightFragmentDeclaration = {
  name: name$20,
  shader: shader$20
}, name$19 = "lightUboDeclaration", shader$19 = `#ifdef LIGHT{X}
uniform Light{X}
...
ShaderStore.IncludesShadersStore[name$18] || (ShaderStore.IncludesShadersStore[name$18] = shader$18);
var ltcHelperFunctions = {
  name: name$18,
  shader: shader$18
}, name$17 = "clusteredLightingFunctions", shader$17 = `struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;
ShaderStore.IncludesShadersStore[name$17] || (ShaderStore.IncludesShadersStore[name$17] = shader$17);
var clusteredLightingFunctions = {
  name: name$17,
  shader: shader$17
}, name$16 = "lightsFragmentFunctions", shader$16 = `struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
#endif
`;
ShaderStore.IncludesShadersStore[name$16] || (ShaderStore.IncludesShadersStore[name$16] = shader$16);
var lightsFragmentFunctions = {
  name: name$16,
  shader: shader$16
}, name$15 = "shadowsFragmentFunctions", shader$15 = `#ifdef SHADOWS
...
#endif
`;
ShaderStore.IncludesShadersStore[name$15] || (ShaderStore.IncludesShadersStore[name$15] = shader$15);
var shadowsFragmentFunctions = {
  name: name$15,
  shader: shader$15
}, name$14 = "samplerFragmentDeclaration", shader$14 = `#ifdef _DEFINENAME_
...
#endif
`;
ShaderStore.IncludesShadersStore[name$14] || (ShaderStore.IncludesShadersStore[name$14] = shader$14);
var samplerFragmentDeclaration = {
  name: name$14,
  shader: shader$14
}, name$13 = "fresnelFunction", shader$13 = `#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;
ShaderStore.IncludesShadersStore[name$13] || (ShaderStore.IncludesShadersStore[name$13] = shader$13);
var fresnelFunction = {
  name: name$13,
  shader: shader$13
}, name$12 = "reflectionFunction", shader$12 = `vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;
ShaderStore.IncludesShadersStore[name$12] || (ShaderStore.IncludesShadersStore[name$12] = shader$12);
var reflectionFunction = {
  name: name$12,
  shader: shader$12
}, name$11 = "imageProcessingDeclaration", shader$11 = `#ifdef EXPOSURE
...
#endif
`;
ShaderStore.IncludesShadersStore[name$11] || (ShaderStore.IncludesShadersStore[name$11] = shader$11);
var imageProcessingDeclaration = {
  name: name$11,
  shader: shader$11
}, name$10 = "imageProcessingFunctions", shader$10 = `#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;
ShaderStore.IncludesShadersStore[name$10] || (ShaderStore.IncludesShadersStore[name$10] = shader$10);
var imageProcessingFunctions = {
  name: name$10,
  shader: shader$10
}, name$9 = "textureRepetitionFunctions", shader$9 = `#if TEXTURE_REPETITION_MODE>0
...
`;
ShaderStore.IncludesShadersStore[name$9] || (ShaderStore.IncludesShadersStore[name$9] = shader$9);
var textureRepetitionFunctions = {
  name: name$9,
  shader: shader$9
}, name$8 = "bumpFragmentMainFunctions", shader$8 = `#ifndef TEXRD_DEFINED
#define TEXRD(s,uv) texture2D(s,uv)
#define TEXRD_DEFINED
#endif
...
#endif
`;
ShaderStore.IncludesShadersStore[name$8] || (ShaderStore.IncludesShadersStore[name$8] = shader$8);
var bumpFragmentMainFunctions = {
  name: name$8,
  shader: shader$8
}, name$7 = "bumpFragmentFunctions", shader$7 = `#if defined(BUMP)
...
#endif
`;
ShaderStore.IncludesShadersStore[name$7] || (ShaderStore.IncludesShadersStore[name$7] = shader$7);
var bumpFragmentFunctions = {
  name: name$7,
  shader: shader$7
}, name$6 = "bumpFragment", shader$6 = `vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;
ShaderStore.IncludesShadersStore[name$6] || (ShaderStore.IncludesShadersStore[name$6] = shader$6);
var bumpFragment = {
  name: name$6,
  shader: shader$6
}, name$5 = "decalFragment", shader$5 = `#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;
ShaderStore.IncludesShadersStore[name$5] || (ShaderStore.IncludesShadersStore[name$5] = shader$5);
var decalFragment = {
  name: name$5,
  shader: shader$5
}, name$4 = "depthPrePass", shader$4 = `#ifdef DEPTHPREPASS
...
var depthPrePass = {
  name: name$4,
  shader: shader$4
}, name$3 = "lightFragment", shader$3 = `#ifdef LIGHT{X}
...
var lightFragment = {
  name: name$3,
  shader: shader$3
}, name$2 = "logDepthFragment", shader$2 = `#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;
ShaderStore.IncludesShadersStore[name$2] || (ShaderStore.IncludesShadersStore[name$2] = shader$2);
var logDepthFragment = {
  name: name$2,
  shader: shader$2
}, name$1 = "oitFragment", shader$1 = `#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
var oitFragment = {
  name: name$1,
  shader: shader$1
}, name = "defaultPixelShader", shader = `#define CUSTOM_FRAGMENT_EXTENSION
