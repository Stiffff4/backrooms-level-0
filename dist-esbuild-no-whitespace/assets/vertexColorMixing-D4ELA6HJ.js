...
var name$10 = "bonesDeclaration", shader$10 = `#if NUM_BONE_INFLUENCERS>0
...
var bonesDeclaration = {
  name: name$10,
  shader: shader$10
}, name$9 = "bakedVertexAnimationDeclaration", shader$9 = `#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
...
var bakedVertexAnimationDeclaration = {
  name: name$9,
  shader: shader$9
}, name$8 = "clipPlaneVertexDeclaration", shader$8 = `#ifdef CLIPPLANE
...
var clipPlaneVertexDeclaration = {
  name: name$8,
  shader: shader$8
}, name$7 = "fogVertexDeclaration", shader$7 = `#ifdef FOG
...
var fogVertexDeclaration = {
  name: name$7,
  shader: shader$7
}, name$6 = "instancesDeclaration", shader$6 = `#ifdef INSTANCES
...
var instancesDeclaration = {
  name: name$6,
  shader: shader$6
}, name$5 = "instancesVertex", shader$5 = `#ifdef INSTANCES
...
var instancesVertex = {
  name: name$5,
  shader: shader$5
}, name$4 = "bonesVertex", shader$4 = `#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
var bonesVertex = {
  name: name$4,
  shader: shader$4
}, name$3 = "bakedVertexAnimation", shader$3 = `#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
...
var bakedVertexAnimation = {
  name: name$3,
  shader: shader$3
}, name$2 = "clipPlaneVertex", shader$2 = `#ifdef CLIPPLANE
...
var clipPlaneVertex = {
  name: name$2,
  shader: shader$2
}, name$1 = "fogVertex", shader$1 = `#ifdef FOG
...
var fogVertex = {
  name: name$1,
  shader: shader$1
}, name = "vertexColorMixing", shader = `#if defined(VERTEXCOLOR) || defined(INSTANCESCOLOR) && defined(INSTANCES)
vColor=vec4(1.0);
#ifdef VERTEXCOLOR
#ifdef VERTEXALPHA
vColor*=colorUpdated;
...
export {
  bonesVertex as a,
  fogVertexDeclaration as c,
  bonesDeclaration as d,
  bakedVertexAnimation as i,
  clipPlaneVertexDeclaration as l,
  fogVertex as n,
  instancesVertex as o,
  clipPlaneVertex as r,
  instancesDeclaration as s,
  vertexColorMixing as t,
  bakedVertexAnimationDeclaration as u
};
