...
var name$18 = "defaultVertexDeclaration";
var shader$18 = `uniform mat4 viewProjection;
#ifdef MULTIVIEW
...
var name$17 = "uvAttributeDeclaration";
var shader$17 = `#ifdef UV{X}
attribute vec2 uv{X};
#endif
`;
...
var name$16 = "prePassVertexDeclaration";
var shader$16 = `#ifdef PREPASS
...
var name$15 = "samplerVertexDeclaration";
var shader$15 = `#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
...
var name$14 = "bumpVertexDeclaration";
var shader$14 = `#if defined(BUMP) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
...
var name$13 = "lightVxFragmentDeclaration";
var shader$13 = `#ifdef LIGHT{X}
...
var name$12 = "lightVxUboDeclaration";
var shader$12 = `#ifdef LIGHT{X}
uniform Light{X}
...
var name$11 = "morphTargetsVertexGlobalDeclaration";
var shader$11 = `#ifdef MORPHTARGETS
...
var name$10 = "morphTargetsVertexDeclaration";
var shader$10 = `#ifdef MORPHTARGETS
...
var name$9 = "morphTargetsVertexGlobal";
var shader$9 = `#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
float vertexID;
#endif
#endif
...
var name$8 = "morphTargetsVertex";
var shader$8 = `#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
#if {X}==0
...
var name$7 = "prePassVertex";
var shader$7 = `#ifdef PREPASS_DEPTH
...
var name$6 = "uvVariableDeclaration";
var shader$6 = `#if !defined(UV{X}) && defined(MAINUV{X})
vec2 uv{X}=vec2(0.,0.);
#endif
#ifdef MAINUV{X}
vMainUV{X}=uv{X};
...
var name$5 = "samplerVertexImplementation";
var shader$5 = `#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
if (v_INFONAME_==0.)
...
var name$4 = "bumpVertex";
var shader$4 = `#if defined(BUMP) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
#if defined(TANGENT) && defined(NORMAL)
...
var name$3 = "shadowsVertex";
var shader$3 = `#ifdef SHADOWS
...
var name$2 = "pointCloudVertex";
var shader$2 = `#if defined(POINTSIZE) && !defined(WEBGPU)
...
var name$1 = "logDepthVertex";
var shader$1 = `#ifdef LOGARITHMICDEPTH
