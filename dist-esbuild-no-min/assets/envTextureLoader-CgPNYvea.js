const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/rgbdDecode.fragment-Ba79okvT.js","assets/shaderStore-Bfhtreha.js","assets/helperFunctions-CoL4eFRs.js","assets/rgbdDecode.fragment-C_ZtffJg.js","assets/helperFunctions-CPqKBgbe.js"])))=>i.map(i=>d[i]);
import { i as GetBlobBufferSource } from "./guid-CkhjUkgR.js";
import { t as Logger } from "./logger-X7NGrhaj.js";
import { s as IsExponentOfTwo, t as PostProcess } from "./postProcess.pure-CbZyFo-1.js";
import { t as BaseTexture } from "./baseTexture.pure-Cr8BPE06.js";
import { u as Vector3 } from "./math.color.pure-CMvYqpy_.js";
import { r as ILog2 } from "./math.scalar.functions-BxWMGrCV.js";
import { t as __vitePreload } from "./preload-helper-C1VGUTyY.js";
import { t as InternalTexture } from "./internalTexture-Bd-9lST5.js";
import { n as SphericalPolynomial } from "./sphericalPolynomial.pure-YKiWfq2o.js";
...
function GetEnvInfo(data) {
  ...
  if (manifest.specular) manifest.specular.lodGenerationScale = manifest.specular.lodGenerationScale || 0.8;
  return manifest;
}
...
async function _UploadLevelsAsync(texture, imageData, canGenerateNonLODTextures, imageType = DefaultEnvironmentTextureImageType) {
  ...
  if (expandTexture) {
    if (engine.isWebGPU) {
      shaderLanguage = 1;
      await __vitePreload(() => import("./rgbdDecode.fragment-Ba79okvT.js"), __vite__mapDeps([0,1,2]));
    } else await __vitePreload(() => import("./rgbdDecode.fragment-C_ZtffJg.js"), __vite__mapDeps([3,1,4]));
