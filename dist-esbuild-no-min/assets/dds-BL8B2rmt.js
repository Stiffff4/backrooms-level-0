import { t as RandomGUID } from "./guid-CkhjUkgR.js";
import { t as Logger } from "./logger-X7NGrhaj.js";
import { a as LoadImage } from "./fileTools.pure-Bmuhm6QP.js";
import { n as AbstractEngine } from "./preload-helper-C1VGUTyY.js";
import { t as InternalTexture } from "./internalTexture-Bd-9lST5.js";
import { t as _GetCompatibleTextureLoader } from "./textureLoaderManager-BgQdOMOp.js";
import { t as DDSTools } from "./dds.pure-BX4ZgjL7.js";
  ...
  AbstractEngine.prototype.createCubeTextureBase = function(rootUrl, scene, files, noMipmap, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = false, lodScale = 0, lodOffset = 0, fallback = null, beforeLoadCubeDataCallback = null, imageHandler = null, useSRGBBuffer = false, buffer = null) {
    ...
    if (loaderPromise) loaderPromise.then((loader) => {
      ...
      this._cascadeLoadImgs(scene, texture, (texture2, imgs) => {
        if (imageHandler) imageHandler(texture2, imgs);
      }, files, localOnError);
    }
