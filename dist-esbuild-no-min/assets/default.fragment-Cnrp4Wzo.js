...
import { i as clipPlaneFragmentDeclaration, n as clipPlaneFragment, r as fogFragmentDeclaration, t as fogFragment } from "./fogFragment-CSulPEf4.js";
...
var name$24 = "decalFragmentDeclaration";
var shader$24 = `#ifdef DECAL
...
var name$23 = "defaultFragmentDeclaration";
...
var name$20 = "lightFragmentDeclaration";
...
var name$19 = "lightUboDeclaration";
var shader$19 = `#ifdef LIGHT{X}
uniform Light{X}
...
var name$18 = "ltcHelperFunctions";
var shader$18 = `vec2 LTCUv( const in vec3 N,const in vec3 V,const in float roughness ) {const float LUTSIZE=64.0;const float LUTSCALE=( LUTSIZE-1.0 )/LUTSIZE;const float LUTBIAS=0.5/LUTSIZE;float dotNV=saturate( dot( N,V ) );vec2 uv=vec2( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
var name$17 = "clusteredLightingFunctions";
var shader$17 = `struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
var shader$12 = `vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
var shader$10 = `#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
var shader$6 = `vec2 uvOffset=vec2(0.0,0.0);
