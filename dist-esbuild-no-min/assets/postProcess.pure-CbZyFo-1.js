const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/postprocess.vertex-TxuqpPY_.js","assets/shaderStore-Bfhtreha.js","assets/postprocess.vertex-1HtN4dNh.js"])))=>i.map(i=>d[i]);
import { n as RegisterClass, s as Observable, t as GetClass } from "./typeStore-CRwQ34I6.js";
import { c as TimingTools } from "./guid-CkhjUkgR.js";
import { _ as __esDecorate, a as serialize, n as SerializationHelper, s as serializeAsColor4, v as __runInitializers } from "./baseTexture.pure-Cr8BPE06.js";
import { l as Vector2 } from "./math.color.pure-CMvYqpy_.js";
import { i as Effect, n as AbstractEngine, t as __vitePreload } from "./preload-helper-C1VGUTyY.js";
...
var EffectWrapper = class EffectWrapper2 {
  ...
  _postConstructor(blockCompilation, defines = null, extraInitializations, importPromises) {
    ...
    if (this.options.useShaderStore && this._shaderPath.vertex === "postprocess") this._importPromises.push(useWebGPU && this._webGPUReady ? __vitePreload(() => import("./postprocess.vertex-TxuqpPY_.js"), __vite__mapDeps([0,1])) : __vitePreload(() => import("./postprocess.vertex-1HtN4dNh.js"), __vite__mapDeps([2,1])));
  ...
  bind(noDefaultBindings = false) {
    ...
    EffectWrapper2._GetShaderCodeProcessing(this.name)?.bindCustomBindings?.(this.name, this._drawWrapper.effect);
  }
...
var PostProcess = (() => {
  ...
  return _a = class PostProcess {
    ...
    _gatherImports(useWebGPU = false, list) {
      if (useWebGPU && this._webGPUReady) list.push(Promise.all([__vitePreload(() => import("./postprocess.vertex-TxuqpPY_.js"), __vite__mapDeps([0,1]))]));
      else list.push(Promise.all([__vitePreload(() => import("./postprocess.vertex-1HtN4dNh.js"), __vite__mapDeps([2,1]))]));
    }
    getClassName() {
      return "PostProcess";
    }
