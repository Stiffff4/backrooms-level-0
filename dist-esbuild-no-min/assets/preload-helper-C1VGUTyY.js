...
import { C as _WarnImport, D as IsNavigatorAvailable, E as IsDocumentAvailable, O as IsWindowObjectExist, T as GetDOMTextContent, d as Initialize, f as Process, g as _ConcatenateShader, h as EngineFunctionContext, l as _RetryWithInterval, u as Finalize, v as _LoadFile, w as PrecisionDate } from "./guid-CkhjUkgR.js";
import { t as Logger } from "./logger-X7NGrhaj.js";
import { m as PerformanceConfigurator } from "./math.color.pure-CMvYqpy_.js";
import { t as ShaderStore } from "./shaderStore-Bfhtreha.js";
import { t as InternalTexture } from "./internalTexture-Bd-9lST5.js";
    ...
    if (shaderCodes[0] && shaderCodes[1]) {
      ...
      Process(vertexCode, processorOptions, (migratedVertexCode, codeBeforeMigration) => {
        ...
        Process(fragmentCode, processorOptions, (migratedFragmentCode, codeBeforeMigration2) => {
          if (effectContext) effectContext._fragmentSourceCodeBeforeMigration = codeBeforeMigration2;
...
Caused by: ${error.stack}`;
  ...
  _onRenderingStateCompiled(pipelineContext) {
    ...
    if (Effect2.AutomaticallyClearCodeCache) this.clearCodeCache();
  }
  ...
  bindUniformBuffer(buffer, name) {
    ...
    if (bufferName === void 0 || Effect2._BaseCache[bufferName] === buffer && this._engine._features.useUBOBindingCache) return;
...
var StencilState = class StencilState2 {
  constructor() {
    this.reset();
  }
  reset() {
    ...
    this.backFunc = StencilState2.ALWAYS;
    this.backOpStencilFail = StencilState2.KEEP;
    this.backOpDepthFail = StencilState2.KEEP;
    this.backOpStencilDepthPass = StencilState2.REPLACE;
  }
  get stencilFunc() {
    return this.func;
  }
...
var AbstractEngine = class AbstractEngine2 {
  ...
  _cancelFrame() {
    if (this.customAnimationFrameRequester) {
      if (this._frameHandler !== 0) {
        ...
        if (cancelAnimationFrame2) cancelAnimationFrame2(this.customAnimationFrameRequester.requestID);
  ...
  _createTextureBase(url, noMipmap, invertY, scene, samplingMode = 3, onLoad = null, onError = null, prepareTexture, prepareTextureProcess, buffer = null, fallback = null, format = null, forcedExtension = null, mimeType, loaderOptions, useSRGBBuffer) {
    ...
    if (loaderPromise) {
      ...
      else AbstractEngine2._FileToolsLoadImage(url || "", onload, onInternalError, scene ? scene.offlineProvider : null, mimeType, texture.invertY && this._features.needsInvertingBitmap ? { imageOrientation: "flipY" } : void 0, this);
      else if (typeof buffer === "string" || buffer instanceof ArrayBuffer || ArrayBuffer.isView(buffer) || buffer instanceof Blob) AbstractEngine2._FileToolsLoadImage(buffer, onload, onInternalError, scene ? scene.offlineProvider : null, mimeType, texture.invertY && this._features.needsInvertingBitmap ? { imageOrientation: "flipY" } : void 0, this);
