...
import { i as clipPlaneFragmentDeclarationWGSL, n as clipPlaneFragmentWGSL, r as fogFragmentDeclarationWGSL, t as fogFragmentWGSL } from "./fogFragment-BHVnFvbY.js";
...
var shader$20 = `#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
var shader$18 = `fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
var shader$17 = `struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
vLightDirection: vec4f,
vLightFalloff: vec4f,}
