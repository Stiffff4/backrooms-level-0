import{t as ShaderStore}from"./shaderStore-DrmLqj-8.js";import{i as clipPlaneFragmentDeclarationWGSL,n as clipPlaneFragmentWGSL,r as fogFragmentDeclarationWGSL,t as fogFragmentWGSL}from"./fogFragment-qYALyi_3.js";import{a as sceneUboDeclarationWGSL,i as meshUboDeclarationWGSL,n as mainUVVaryingDeclarationWGSL,r as defaultUboDeclarationWGSL,t as logDepthDeclarationWGSL}from"./logDepthDeclaration-FwyCpGTA.js";import{t as helperFunctionsWGSL}from"./helperFunctions-DEYY4AP9.js";var name$21="prePassDeclaration";var shader$21=`#ifdef PREPASS
...
#endif
#endif
`;if(!ShaderStore.IncludesShadersStoreWGSL[name$21])ShaderStore.IncludesShadersStoreWGSL[name$21]=shader$21;var prePassDeclarationWGSL={name:name$21,shader:shader$21};var name$20="oitDeclaration";var shader$20=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;if(!ShaderStore.IncludesShadersStoreWGSL[name$20])ShaderStore.IncludesShadersStoreWGSL[name$20]=shader$20;var oitDeclarationWGSL={name:name$20,shader:shader$20};var name$19="lightUboDeclaration";var shader$19=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
#endif
`;if(!ShaderStore.IncludesShadersStoreWGSL[name$19])ShaderStore.IncludesShadersStoreWGSL[name$19]=shader$19;var lightUboDeclarationWGSL={name:name$19,shader:shader$19};var name$18="ltcHelperFunctions";var shader$18=`fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
`;if(!ShaderStore.IncludesShadersStoreWGSL[name$18])ShaderStore.IncludesShadersStoreWGSL[name$18]=shader$18;var ltcHelperFunctionsWGSL={name:name$18,shader:shader$18};var name$17="clusteredLightingFunctions";var shader$17=`struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
vLightDirection: vec4f,
vLightFalloff: vec4f,}
...
`;if(!ShaderStore.IncludesShadersStoreWGSL[name$17])ShaderStore.IncludesShadersStoreWGSL[name$17]=shader$17;var clusteredLightingFunctionsWGSL={name:name$17,shader:shader$17};var name$16="lightsFragmentFunctions";var shader$16=`struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
#endif
...
return result;}
#endif
`;if(!ShaderStore.IncludesShadersStoreWGSL[name$16])ShaderStore.IncludesShadersStoreWGSL[name$16]=shader$16;var lightsFragmentFunctionsWGSL={name:name$16,shader:shader$16};var name$15="shadowsFragmentFunctions";var shader$15=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;if(!ShaderStore.IncludesShadersStoreWGSL[name$15])ShaderStore.IncludesShadersStoreWGSL[name$15]=shader$15;var shadowsFragmentFunctionsWGSL={name:name$15,shader:shader$15};var name$14="samplerFragmentDeclaration";var shader$14=`#ifdef _DEFINENAME_
...
#endif
`;if(!ShaderStore.IncludesShadersStoreWGSL[name$14])ShaderStore.IncludesShadersStoreWGSL[name$14]=shader$14;var samplerFragmentDeclarationWGSL={name:name$14,shader:shader$14};var name$13="fresnelFunction";var shader$13=`#ifdef FRESNEL
fn computeFresnelTerm(viewDirection: vec3f,worldNormal: vec3f,bias: f32,power: f32)->f32
{let fresnelTerm: f32=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;if(!ShaderStore.IncludesShadersStoreWGSL[name$13])ShaderStore.IncludesShadersStoreWGSL[name$13]=shader$13;var fresnelFunctionWGSL={name:name$13,shader:shader$13};var name$12="reflectionFunction";var shader$12=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;if(!ShaderStore.IncludesShadersStoreWGSL[name$12])ShaderStore.IncludesShadersStoreWGSL[name$12]=shader$12;var reflectionFunctionWGSL={name:name$12,shader:shader$12};var name$11="imageProcessingDeclaration";var shader$11=`#ifdef EXPOSURE
...
#endif
`;if(!ShaderStore.IncludesShadersStoreWGSL[name$11])ShaderStore.IncludesShadersStoreWGSL[name$11]=shader$11;var imageProcessingDeclarationWGSL={name:name$11,shader:shader$11};var name$10="imageProcessingFunctions";var shader$10=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;if(!ShaderStore.IncludesShadersStoreWGSL[name$10])ShaderStore.IncludesShadersStoreWGSL[name$10]=shader$10;var imageProcessingFunctionsWGSL={name:name$10,shader:shader$10};var name$9="textureRepetitionFunctions";var shader$9=`#if TEXTURE_REPETITION_MODE>0
...
`;if(!ShaderStore.IncludesShadersStoreWGSL[name$9])ShaderStore.IncludesShadersStoreWGSL[name$9]=shader$9;var textureRepetitionFunctionsWGSL={name:name$9,shader:shader$9};var name$8="bumpFragmentMainFunctions";var shader$8=`#ifndef TEXRD_DEFINED
fn TEXRD(t: texture_2d<f32>,ts: sampler,uv: vec2f)->vec4f {return textureSample(t,ts,uv);}
#define TEXRD_DEFINED
#endif
...
#endif
`;if(!ShaderStore.IncludesShadersStoreWGSL[name$8])ShaderStore.IncludesShadersStoreWGSL[name$8]=shader$8;var bumpFragmentMainFunctionsWGSL={name:name$8,shader:shader$8};var name$7="bumpFragmentFunctions";var shader$7=`#if defined(BUMP)
...
#endif
`;if(!ShaderStore.IncludesShadersStoreWGSL[name$7])ShaderStore.IncludesShadersStoreWGSL[name$7]=shader$7;var bumpFragmentFunctionsWGSL={name:name$7,shader:shader$7};var name$6="bumpFragment";var shader$6=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;if(!ShaderStore.IncludesShadersStoreWGSL[name$6])ShaderStore.IncludesShadersStoreWGSL[name$6]=shader$6;var bumpFragmentWGSL={name:name$6,shader:shader$6};var name$5="decalFragment";var shader$5=`#ifdef DECAL
...
#endif
`;if(!ShaderStore.IncludesShadersStoreWGSL[name$5])ShaderStore.IncludesShadersStoreWGSL[name$5]=shader$5;var decalFragmentWGSL={name:name$5,shader:shader$5};var name$4="depthPrePass";var shader$4=`#ifdef DEPTHPREPASS
#if !defined(PREPASS) && !defined(ORDER_INDEPENDENT_TRANSPARENCY)
fragmentOutputs.color= vec4f(0.,0.,0.,1.0);
#endif
return fragmentOutputs;
#endif
`;if(!ShaderStore.IncludesShadersStoreWGSL[name$4])ShaderStore.IncludesShadersStoreWGSL[name$4]=shader$4;var depthPrePassWGSL={name:name$4,shader:shader$4};var name$3="lightFragment";var shader$3=`#ifdef LIGHT{X}
...
#endif
#endif
`;if(!ShaderStore.IncludesShadersStoreWGSL[name$3])ShaderStore.IncludesShadersStoreWGSL[name$3]=shader$3;var lightFragmentWGSL={name:name$3,shader:shader$3};var name$2="logDepthFragment";var shader$2=`#ifdef LOGARITHMICDEPTH
fragmentOutputs.fragDepth=log2(fragmentInputs.vFragmentDepth)*uniforms.logarithmicDepthConstant*0.5;
#endif
`;if(!ShaderStore.IncludesShadersStoreWGSL[name$2])ShaderStore.IncludesShadersStoreWGSL[name$2]=shader$2;var logDepthFragmentWGSL={name:name$2,shader:shader$2};var name$1="oitFragment";var shader$1=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;if(!ShaderStore.IncludesShadersStoreWGSL[name$1])ShaderStore.IncludesShadersStoreWGSL[name$1]=shader$1;var oitFragmentWGSL={name:name$1,shader:shader$1};var name="defaultPixelShader";var shader=`#include<defaultUboDeclaration>
...
`;if(!ShaderStore.ShadersStoreWGSL[name])ShaderStore.ShadersStoreWGSL[name]=shader;var includes=[sceneUboDeclarationWGSL,meshUboDeclarationWGSL,defaultUboDeclarationWGSL,prePassDeclarationWGSL,oitDeclarationWGSL,mainUVVaryingDeclarationWGSL,helperFunctionsWGSL,lightUboDeclarationWGSL,ltcHelperFunctionsWGSL,clusteredLightingFunctionsWGSL,lightsFragmentFunctionsWGSL,shadowsFragmentFunctionsWGSL,samplerFragmentDeclarationWGSL,fresnelFunctionWGSL,reflectionFunctionWGSL,imageProcessingDeclarationWGSL,imageProcessingFunctionsWGSL,textureRepetitionFunctionsWGSL,bumpFragmentMainFunctionsWGSL,bumpFragmentFunctionsWGSL,clipPlaneFragmentDeclarationWGSL,logDepthDeclarationWGSL,fogFragmentDeclarationWGSL,clipPlaneFragmentWGSL,bumpFragmentWGSL,decalFragmentWGSL,depthPrePassWGSL,lightFragmentWGSL,logDepthFragmentWGSL,fogFragmentWGSL,oitFragmentWGSL];for(const inc of includes)if(!ShaderStore.IncludesShadersStoreWGSL[inc.name])ShaderStore.IncludesShadersStoreWGSL[inc.name]=inc.shader;var defaultPixelShaderWGSL={name,shader};export{defaultPixelShaderWGSL};
