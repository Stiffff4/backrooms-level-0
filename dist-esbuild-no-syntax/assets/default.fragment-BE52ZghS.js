import{t as ShaderStore}from"./shaderStore-DrmLqj-8.js";import{i as clipPlaneFragmentDeclaration,n as clipPlaneFragment,r as fogFragmentDeclaration,t as fogFragment}from"./fogFragment-CoopuqZ_.js";import{a as sceneUboDeclaration,i as meshUboDeclaration,n as mainUVVaryingDeclaration,r as defaultUboDeclaration,t as logDepthDeclaration}from"./logDepthDeclaration-CAyGf3ep.js";import{t as helperFunctions}from"./helperFunctions-DTB-E9OJ.js";var name$24="decalFragmentDeclaration";var shader$24=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;if(!ShaderStore.IncludesShadersStore[name$24])ShaderStore.IncludesShadersStore[name$24]=shader$24;var decalFragmentDeclaration={name:name$24,shader:shader$24};var name$23="defaultFragmentDeclaration";var shader$23=`uniform vec4 vEyePosition;uniform vec4 vDiffuseColor;uniform vec4 vSpecularColor;uniform vec3 vEmissiveColor;uniform vec3 vAmbientColor;uniform float visibility;
#ifdef DIFFUSE
...
`;if(!ShaderStore.IncludesShadersStore[name$23])ShaderStore.IncludesShadersStore[name$23]=shader$23;var defaultFragmentDeclaration={name:name$23,shader:shader$23};var name$22="prePassDeclaration";var shader$22=`#ifdef PREPASS
...
#endif
#endif
`;if(!ShaderStore.IncludesShadersStore[name$22])ShaderStore.IncludesShadersStore[name$22]=shader$22;var prePassDeclaration={name:name$22,shader:shader$22};var name$21="oitDeclaration";var shader$21=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;if(!ShaderStore.IncludesShadersStore[name$21])ShaderStore.IncludesShadersStore[name$21]=shader$21;var oitDeclaration={name:name$21,shader:shader$21};var name$20="lightFragmentDeclaration";var shader$20=`#ifdef LIGHT{X}
...
#endif
#endif
`;if(!ShaderStore.IncludesShadersStore[name$20])ShaderStore.IncludesShadersStore[name$20]=shader$20;var lightFragmentDeclaration={name:name$20,shader:shader$20};var name$19="lightUboDeclaration";var shader$19=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;if(!ShaderStore.IncludesShadersStore[name$18])ShaderStore.IncludesShadersStore[name$18]=shader$18;var ltcHelperFunctions={name:name$18,shader:shader$18};var name$17="clusteredLightingFunctions";var shader$17=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;if(!ShaderStore.IncludesShadersStore[name$17])ShaderStore.IncludesShadersStore[name$17]=shader$17;var clusteredLightingFunctions={name:name$17,shader:shader$17};var name$16="lightsFragmentFunctions";var shader$16=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
return result;}
#endif
`;if(!ShaderStore.IncludesShadersStore[name$16])ShaderStore.IncludesShadersStore[name$16]=shader$16;var lightsFragmentFunctions={name:name$16,shader:shader$16};var name$15="shadowsFragmentFunctions";var shader$15=`#ifdef SHADOWS
...
#endif
#endif
`;if(!ShaderStore.IncludesShadersStore[name$15])ShaderStore.IncludesShadersStore[name$15]=shader$15;var shadowsFragmentFunctions={name:name$15,shader:shader$15};var name$14="samplerFragmentDeclaration";var shader$14=`#ifdef _DEFINENAME_
...
#endif
`;if(!ShaderStore.IncludesShadersStore[name$14])ShaderStore.IncludesShadersStore[name$14]=shader$14;var samplerFragmentDeclaration={name:name$14,shader:shader$14};var name$13="fresnelFunction";var shader$13=`#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;if(!ShaderStore.IncludesShadersStore[name$13])ShaderStore.IncludesShadersStore[name$13]=shader$13;var fresnelFunction={name:name$13,shader:shader$13};var name$12="reflectionFunction";var shader$12=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;if(!ShaderStore.IncludesShadersStore[name$12])ShaderStore.IncludesShadersStore[name$12]=shader$12;var reflectionFunction={name:name$12,shader:shader$12};var name$11="imageProcessingDeclaration";var shader$11=`#ifdef EXPOSURE
...
#endif
`;if(!ShaderStore.IncludesShadersStore[name$11])ShaderStore.IncludesShadersStore[name$11]=shader$11;var imageProcessingDeclaration={name:name$11,shader:shader$11};var name$10="imageProcessingFunctions";var shader$10=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;if(!ShaderStore.IncludesShadersStore[name$10])ShaderStore.IncludesShadersStore[name$10]=shader$10;var imageProcessingFunctions={name:name$10,shader:shader$10};var name$9="textureRepetitionFunctions";var shader$9=`#if TEXTURE_REPETITION_MODE>0
...
`;if(!ShaderStore.IncludesShadersStore[name$9])ShaderStore.IncludesShadersStore[name$9]=shader$9;var textureRepetitionFunctions={name:name$9,shader:shader$9};var name$8="bumpFragmentMainFunctions";var shader$8=`#ifndef TEXRD_DEFINED
#define TEXRD(s,uv) texture2D(s,uv)
#define TEXRD_DEFINED
#endif
...
#endif
`;if(!ShaderStore.IncludesShadersStore[name$8])ShaderStore.IncludesShadersStore[name$8]=shader$8;var bumpFragmentMainFunctions={name:name$8,shader:shader$8};var name$7="bumpFragmentFunctions";var shader$7=`#if defined(BUMP)
...
#endif
`;if(!ShaderStore.IncludesShadersStore[name$7])ShaderStore.IncludesShadersStore[name$7]=shader$7;var bumpFragmentFunctions={name:name$7,shader:shader$7};var name$6="bumpFragment";var shader$6=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;if(!ShaderStore.IncludesShadersStore[name$6])ShaderStore.IncludesShadersStore[name$6]=shader$6;var bumpFragment={name:name$6,shader:shader$6};var name$5="decalFragment";var shader$5=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;if(!ShaderStore.IncludesShadersStore[name$5])ShaderStore.IncludesShadersStore[name$5]=shader$5;var decalFragment={name:name$5,shader:shader$5};var name$4="depthPrePass";var shader$4=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;if(!ShaderStore.IncludesShadersStore[name$4])ShaderStore.IncludesShadersStore[name$4]=shader$4;var depthPrePass={name:name$4,shader:shader$4};var name$3="lightFragment";var shader$3=`#ifdef LIGHT{X}
...
#endif
#endif
`;if(!ShaderStore.IncludesShadersStore[name$3])ShaderStore.IncludesShadersStore[name$3]=shader$3;var lightFragment={name:name$3,shader:shader$3};var name$2="logDepthFragment";var shader$2=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;if(!ShaderStore.IncludesShadersStore[name$2])ShaderStore.IncludesShadersStore[name$2]=shader$2;var logDepthFragment={name:name$2,shader:shader$2};var name$1="oitFragment";var shader$1=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;if(!ShaderStore.IncludesShadersStore[name$1])ShaderStore.IncludesShadersStore[name$1]=shader$1;var oitFragment={name:name$1,shader:shader$1};var name="defaultPixelShader";var shader=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;if(!ShaderStore.ShadersStore[name])ShaderStore.ShadersStore[name]=shader;var includes=[decalFragmentDeclaration,defaultFragmentDeclaration,sceneUboDeclaration,meshUboDeclaration,defaultUboDeclaration,prePassDeclaration,oitDeclaration,mainUVVaryingDeclaration,helperFunctions,lightFragmentDeclaration,lightUboDeclaration,ltcHelperFunctions,clusteredLightingFunctions,lightsFragmentFunctions,shadowsFragmentFunctions,samplerFragmentDeclaration,fresnelFunction,reflectionFunction,imageProcessingDeclaration,imageProcessingFunctions,textureRepetitionFunctions,bumpFragmentMainFunctions,bumpFragmentFunctions,clipPlaneFragmentDeclaration,logDepthDeclaration,fogFragmentDeclaration,clipPlaneFragment,bumpFragment,decalFragment,depthPrePass,lightFragment,logDepthFragment,fogFragment,oitFragment];for(const inc of includes)if(!ShaderStore.IncludesShadersStore[inc.name])ShaderStore.IncludesShadersStore[inc.name]=inc.shader;var defaultPixelShader={name,shader};export{defaultPixelShader};
