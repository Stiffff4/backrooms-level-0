...
> = Object.freeze({
  ...
  'intermittent-failure': curve({
    ...
    audioMin: 0.993,
    audioMax: 1,
    primaryFrequencyHz: 3.1,
    secondaryFrequencyHz: 6.8,
    secondaryMix: 0.18,
    frequencyJitter: 0.07,
    reducedVisualDepthScale: 0.16,
    reducedAudioDepthScale: 0.18,
    reducedVisualFloor: 0.94,
    reducedAudioFloor: 0.95,
    failure: {
      cycleSeconds: 11.5,
      eventChance: 0.1,
      holdSecondsMin: 0.045,
      holdSecondsMax: 0.09,
      attackSeconds: 0.018,
      releaseSeconds: 0.05,
      visualTargetMin: 0.84,
      visualTargetMax: 0.93,
      audioTargetMin: 0.92,
      audioTargetMax: 0.97,
    },
  }),
